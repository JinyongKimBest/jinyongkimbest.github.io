...
The workflow `.github/workflows/` runs automatically to fetch and update publication citation counts. Scripts are in `scripts/citation-api.js`. Do not manually edit citation count fields in `publications.yml` — they will be overwritten.
